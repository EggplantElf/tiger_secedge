...
python make_features_map_SBC.py -test -i $EXDIR/test.MAC.conll09 -m $EXDIR/map_SBC.map -o $EXDIR/map_SBCtest.features

echo "train and predict..."
../liblinear/train $EXDIR/map_SBC_train.features $EXDIR/map_SBC.model
../liblinear/predict $EXDIR/map_SBCtest.features $EXDIR/map_SBC.model $EXDIR/pred.txt
