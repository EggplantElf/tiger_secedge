...
echo "test data"
python $PY_DIR/cut_xml.py $DATA_DIR/tiger8.1.5.xml $DATA_DIR/head.xml $EXP_DIR/tiger.auto.test.xml $START $END
...
echo "training data"
python $PY_DIR/cut_xml.py -r $DATA_DIR/tiger8.1.5.xml $DATA_DIR/head.xml $DATA_DIR/tiger.train.xml $START $END
