...
cp experiment/data/ex0/tiger.gold.conll09 $EXP_DIR
...
python scripts/make_features_MA.py -mapback -i $EXP_DIR/tiger.gold.C.conll09 -m $EXP_DIR/find_MA.map -o $EXP_DIR/tiger.test.C.conll09 -p $EXP_DIR/pred_MA.txt  -f MA.feat



./step2_find_C.sh   $EXP_DIR    tiger.test.C.conll09    tiger.pred.C.conll09
